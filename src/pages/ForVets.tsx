...
const ForVets = () => {
  ...
  const benefits = [{
    ...
    description: "Be visible to local pet owners searching online."
  }, {
    icon: BellRing,
    title: "Reduce no-shows",
    description: "Automatic reminders keep your schedule full."
  }, {
    icon: Calendar,
    title: "Simplify your calendar",
    description: "Manage appointments from any device."
  }, {
    icon: Star,
    title: "Build trust",
    description: "Verified reviews and clinic profiles boost credibility."
  }, {
    icon: Shield,
    title: "Data security",
    description: "GDPR-compliant and encrypted platform."
  }, {
    icon: TrendingUp,
    title: "Grow smarter",
    description: "Access insights and performance reports."
  }];
  const steps = [{
    number: "01",
    title: "Sign up and create your clinic profile",
    description: "Takes less than 5 minutes to get started."
  }, {
    number: "02",
    title: "Connect your calendar and set availability",
    description: "Sync with your existing tools or use ours."
  }, {
    number: "03",
    title: "Start receiving bookings instantly",
    description: "Pet owners can find and book you right away."
  }, {
    number: "04",
    title: "Manage, track, and grow your practice",
    description: "Access powerful tools and insights."
  }];
  const pricing = [{
    name: "Basic",
    price: "€49.99",
  ...
  const security = [{
    ...
    icon: FileCheck,
    title: "Full Control",
    description: "You own your clinic data and can export anytime."
  }, {
    icon: Database,
    title: "GDPR-Compliant",
    description: "Hosted securely within the EU."
  }];
  const faqs = [{
  ...
  return <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button size="lg" variant="outline" className="text-lg px-8" onClick={() => setAuthDialogOpen(true)}>
                Login as Vet
              </Button>
            </div>
      ...
      <section className="container py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          return <Card key={index} className="border-2 hover:border-primary transition-colors">
      ...
      <section className="bg-secondary/30 py-20">
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {pricing.map((plan, index) => <Card key={index} className={plan.highlighted ? "border-primary border-2 shadow-xl scale-105" : ""}>
                <CardContent className="pt-6">
      ...
      <VetRegistrationDialog open={dialogOpen} onOpenChange={setDialogOpen} mode={dialogMode} />

      <VetAuthDialog open={authDialogOpen} onOpenChange={setAuthDialogOpen} />
    </div>;
};
