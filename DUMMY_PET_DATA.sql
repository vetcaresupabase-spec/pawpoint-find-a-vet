-- ============================================
-- Dummy Pet Data - 10 Comprehensive Pet Records
-- ============================================
-- Run this AFTER you've run all migrations
-- Replace owner_id values with actual user IDs from your Supabase auth.users table
-- ============================================

-- First, get a sample owner_id (replace with actual user ID)
-- You can find user IDs in Supabase: Authentication -> Users

-- Example: Get owner IDs
-- SELECT id, email FROM auth.users WHERE email LIKE '%petowner%' LIMIT 1;

-- ============================================
-- DUMMY PET 1: Complete Profile - Golden Retriever
-- ============================================
INSERT INTO public.pets (
  ...
  insurance_emergency_hotline,
  -- Contacts
  primary_vet_clinic_name,
  primary_vet_phone,
  primary_vet_address,
  primary_vet_email,
  emergency_clinic_name,
  emergency_clinic_phone,
  emergency_clinic_address,
  microchip_registry_name,
  microchip_registry_id,
  microchip_registry_url,
  -- Travel
  countries_visited,
  intended_travel_countries,
  travel_notes,
  -- Privacy
  data_processing_consent,
  consent_timestamp,
  emergency_sharing_enabled
) VALUES (
  (SELECT id FROM auth.users LIMIT 1 OFFSET 0), -- Replace with actual owner_id
  'John Smith',
  'Dog',
  'Golden Retriever',
  'Buddy',
  ...
  'Male',
  'Yes',
  NULL, -- Photo URL (upload separately)
  ...
  -- Health & Wellness
  'FCI-GR-2020-001',
  'Golden, white chest marking',
  28.5,
  '2024-10-15',
  58.0,
  ARRAY['Hip Dysplasia', 'Seasonal Allergies'],
  'Mild hip dysplasia, managed with exercise. Seasonal allergies in spring.',
  ARRAY['Pollen', 'Dust'],
  'Royal Canin',
  'Dry',
  'Twice daily: 7am (2 cups), 6pm (2 cups)',
  'Very friendly, energetic, loves people and other dogs',
  ...
  'DE',
  '+49 30 99999999, info@goldendreams.de',
  '2020-06-01',
  'VDH',
  'VDH-2020-GR-001234',
  'PetCare Insurance',
  ...
  ARRAY['DE', 'FR', 'IT', 'ES'],
  ARRAY['PT', 'GR'],
  'Requires large crate (size 4). Prefers window seat. Well-behaved on flights.',
  -- Privacy
  true,
  NOW(),
  true
...
-- ============================================
-- DUMMY PET 2: Complete Profile - Persian Cat
-- ============================================
INSERT INTO public.pets (
  ...
  behavior_temperament, behavior_triggers, bite_history,
  ...
  countries_visited, data_processing_consent, consent_timestamp, emergency_sharing_enabled
) VALUES (
  ...
  '2024-09-20',
  25.0,
  ARRAY['Respiratory issues'],
  ARRAY['Certain fish proteins'],
  'Hills Science Diet',
  'Wet',
  'Three times daily: small portions',
  'Calm, gentle, affectionate, shy around strangers',
  'Loud noises, other cats, sudden movements',
  false,
  'rescue',
  'Paris Animal Rescue',
  'FR',
  '+33 1 98765432, contact@parisanimalrescue.fr',
  '2019-06-15',
  'PetSecure',
  'PS-2019-789012',
  'Cat Care Clinic',
...
-- ============================================
-- DUMMY PET 3: Minimal Profile - Mixed Breed Dog
-- ============================================
INSERT INTO public.pets (
  owner_id, owner_name, pet_type, breed, name, date_of_birth, sex, neutered_spayed,
  notes,
...
-- ============================================
-- DUMMY PET 4: Complete Profile - German Shepherd
-- ============================================
INSERT INTO public.pets (
  owner_id, owner_name, pet_type, breed, name, date_of_birth, sex, neutered_spayed,
  notes,
  ...
  past_surgeries,
  diet_brand, diet_type, feeding_schedule,
  behavior_temperament, behavior_notes, bite_history,
  ...
  'Dry',
  'Twice daily: 8am (1.5 cups), 7pm (1.5 cups)',
  'Obedient, protective, intelligent, loyal',
  'Excellent with commands. Needs regular mental stimulation.',
  false,
  'breeder',
  'Elite German Shepherds',
  'DE',
  '+49 30 77777777, contact@elitegs.de',
  '2018-12-01',
  'VDH',
  'VDH-2018-GS-005678',
  'Comprehensive Pet Insurance',
  'CPI-2018-456789',
  'Berlin Veterinary Center',
  '+49 30 22222222',
  'Karl-Marx-Allee 45, 10178 Berlin',
  'Berlin Emergency Veterinary',
  '+49 30 33333333',
  'Tasso',
  'TS-2018-005678',
  ARRAY['DE', 'AT', 'CH', 'CZ'],
  'Experienced traveler. Well-behaved. Needs large crate.',
  true,
  NOW(),
  true
);
...
-- ============================================
-- DUMMY PET 5: Cat - British Shorthair
-- ============================================
INSERT INTO public.pets (
  owner_id, owner_name, pet_type, breed, name, date_of_birth, sex, neutered_spayed,
  notes,
  ...
  'Purina Pro Plan',
  'Dry',
  'Free feeding (measured amount)',
  'Calm, independent, affectionate when he wants',
  'breeder',
  'British Elegance Cattery',
  'GB',
  '2020-03-01',
  'UK Pet Insurance',
  'London Cat Clinic',
  '+44 20 12345678',
  'London Emergency Vet',
  '+44 20 98765432',
  true,
  NOW()
);
...
INSERT INTO public.pets (
  ...
  ARRAY['Chicken'],
  'Eukanuba',
  'Three times daily: 7am, 1pm, 7pm',
  'Highly intelligent, energetic, eager to please, herding instinct',
  'Boredom, being alone too long',
  'Needs at least 2 hours exercise daily. Enjoys agility training.',
  'rescue',
  'Border Collie Rescue Network',
  'DE',
  '2022-05-15',
  'Munich Animal Clinic',
  '+49 89 12345678',
  'Munich Emergency',
  '+49 89 98765432',
  ARRAY['DE', 'AT'],
...
INSERT INTO public.pets (
  ...
  '982000678901234',
  'Seal point (cream body, dark face, ears, paws, tail)',
  4.5,
  '2024-09-25',
  ARRAY['Asthma'],
  ARRAY['Dust', 'Strong perfumes'],
  'Royal Canin Siamese',
  'Wet',
  'Very vocal, social, affectionate, talkative',
  'Being ignored, closed doors, other cats',
  'breeder',
  'Siamese Elegance',
  'IT',
  '2021-08-01',
...
-- ============================================
-- DUMMY PET 8: Dog - French Bulldog
-- ============================================
INSERT INTO public.pets (
  owner_id, owner_name, pet_type, breed, name, date_of_birth, sex, neutered_spayed,
  notes,
  ...
  'FR-11111-2023',
  'FR',
  'Brindle (brown with black stripes)',
  12.5,
  '2024-10-12',
  ARRAY['Brachycephalic syndrome', 'Allergies'],
  'Hills Science Plan Small Breed',
  'Dry',
  'Three small meals: 8am, 2pm, 8pm',
...
-- ============================================
-- DUMMY PET 9: Dog - Labrador Retriever
-- ============================================
INSERT INTO public.pets (
  owner_id, owner_name, pet_type, breed, name, date_of_birth, sex, neutered_spayed,
  notes,
  ...
  'Purina Pro Plan',
  'Twice daily: 7am, 6pm',
  'Very friendly, gentle, loves people and water',
  'Excellent with kids. Loves swimming and retrieving.',
  'private',
  NULL,
  '2019-11-01',
  'Hamburg Animal Care',
...
INSERT INTO public.pets (
  ...
  '982000901234567',
  '2022-11-15',
  'Sable (brown with dark mask)',
  1.2,
  '2024-09-30',
  ARRAY['Insulinoma (monitored)'],
  'Marshall Premium Ferret Diet',
  'Dry pellets',
  'Free feeding (small portions, multiple times)',
...
-- Verification Query
-- ============================================
-- Run this to verify all pets were inserted:
-- SELECT 
--   name, 
--   pet_type, 
--   breed, 
